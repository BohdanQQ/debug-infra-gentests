...
// worker2 throws exception

// depending on the replacement, we expect
// diagonal cases to exit with exception
// replacing 2 with -2 in worker1 (thread 0) in the first call -> exception
// replacing -2 with 2 in worker2 (thread 1) in its first call -> exit code 5 
